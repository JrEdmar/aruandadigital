@extends('layouts.app')
@section('title', 'Estudos Públicos — Aruanda Digital')
...
<style>
    ...
    .pub-hdr h6 { margin:0;font-size:17px;font-weight:800;color:var(--txt); }
    ...
    .pub-banner-text h6 { margin:0;font-size:14px;font-weight:800;color:#4c1d95; }
    .pub-banner-text p  { margin:0;font-size:11px;color:#6d28d9;line-height:1.4;margin-top:2px; }
</style>
@endpush
...
<div class="pub-hdr">
    <h6><i class="bi bi-book me-2" style="color:#7c3aed;"></i>Estudos Públicos</h6>
    <span style="font-size:11px;color:var(--txt-3);font-weight:600;">{{ $studies->total() }} disponíveis</span>
</div>

<div class="pub-banner">
    <div class="pub-banner-icon">
        <i class="bi bi-globe2" style="color:#fff;font-size:20px;"></i>
    </div>
    <div class="pub-banner-text">
        <h6>Conhecimento aberto</h6>
        <p>Estudos compartilhados pelas casas e templos para toda a comunidade.</p>
    </div>
</div>
...
<div class="filter-scroll">
    ...
    <button class="fchip" data-cat="text">Texto</button>
...
<a href="{{ route('studies.show', $study->id) }}" class="study-row"
   ...
   data-cat="{{ strtolower($study->content_type ?? '') }}">
    <img src="{{ $study->thumbnail_url }}" alt="{{ $study->title }}" class="study-thumb"
         onerror="this.src='https://placehold.co/64x64/ede9fe/5b21b6?text=E'">
    <div class="study-info">
        ...
        <div class="study-meta">
            ...
            @endif
            @if($study->house)
            <span class="study-house">
                <i class="bi bi-building" style="font-size:9px;"></i>{{ $study->house->name }}
            </span>
            @endif
            @if($study->points > 0)
...
<div class="empty-state">
    ...
    <p>Nenhum estudo público disponível ainda.</p>
    <small style="color:var(--txt-3);">As casas podem publicar estudos abertos para a comunidade.</small>
</div>
@endforelse
</div>
